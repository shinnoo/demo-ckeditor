...
const Department = () => {
  ...
  const getAll = (page = 1, size = 10) => {
    ...
    axios
      .get(
        `${host}/api/v1/departments?page=${page - 1}&size=${size}&sort=id,desc`
      )
      .then((res) => {
  ...
  const callDelete = () => {
    axios
      .delete(`${host}/api/v1/departments/delete/${selectedId}`)
      .then((res) => {
  ...
  const callPut = (data) => {
    ...
    axios
      .put(`${host}/api/v1/departments`, data)
      .then((res) => {
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <Form.Item name="description" label="Nhiệm vụ">
            <Input />
          </Form.Item>
